...
def labelme_shapes_to_label(img_shape, shapes, t_class=None, line_width=10):
        ...
        for tc in t_class:
            for shape in shapes:
                ...
                if(label_name == tc):
                    ...
                    lbl[mask] = t_class.index(label_name)+1
                    ins_id = ins_id+1
                
    return lbl, label_name_to_value

def labelme_shapes_to_label2(w,h, shapes, t_class=None, line_width=10):
    ...
    for shape in shapes:
        ...
        cls[mask] = shape["cls_id"]
        ins[mask] = shape["ins_id"]
        cls_list.append(cls)
        ins_list.append(ins)
